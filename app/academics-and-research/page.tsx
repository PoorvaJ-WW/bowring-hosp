import { AcademicsAndResearchView } from '@/views/index';
...
export async function generateMetadata(): Promise<Metadata> {
  return await getPageMetadata('/academics-and-research');
}
...
export default async function Page() {
  ...
  return <AcademicsAndResearchView blogPosts={blogPosts} />;
}