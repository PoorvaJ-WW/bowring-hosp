import { PatientTestimonialsView } from '@/views/index';
...
export async function generateMetadata(): Promise<Metadata> {
  return await getPageMetadata('/patient-testimonials');
}

// Server Component - fetches data before rendering
// NO 'use client' directive - this runs on the server!
export default async function Page() {
  // Pre-fetch videos on the server
  const videos = await getVideos(50, 'publishedAt');
  ...
  return <PatientTestimonialsView videos={videos} galleryImages={galleryImages} />;
}