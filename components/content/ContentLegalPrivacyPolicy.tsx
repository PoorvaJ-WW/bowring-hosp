// Generated page-specific component for privacy-policy
// This component is isolated - changes here only affect the privacy-policy page
...
export default function ContentLegalPrivacyPolicyPrivacyPolicy(props: Props) {
