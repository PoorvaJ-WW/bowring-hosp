// Generated page-specific component for terms-and-conditions
// This component is isolated - changes here only affect the terms-and-conditions page
...
export default function ContentLegalTermsAndConditionsTermsAndConditions(props: Props) {
