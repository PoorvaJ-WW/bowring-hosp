// Generated page-specific component for surgical-services
// This component is isolated - changes here only affect the surgical-services page
...
export default function CTASimpleCenteredOnBrandSurgicalServicesSurgicalServices(props: Props) {
  const {
    pageSlug = 'home',
