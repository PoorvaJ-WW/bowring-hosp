// Generated page-specific component for inpatient-services
// This component is isolated - changes here only affect the inpatient-services page
...
export default function TestimonialsBasicCardInpatientServicesInpatientServices(props: Props) {
  const {
    pageSlug = 'home',
