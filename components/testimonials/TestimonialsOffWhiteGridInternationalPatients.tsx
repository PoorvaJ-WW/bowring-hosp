// Generated page-specific component for international-patients
// This component is isolated - changes here only affect the international-patients page
...
export default function TestimonialsOffWhiteGridInternationalPatientsInternationalPatients(props: Props) {
  const {
    pageSlug = 'home',
