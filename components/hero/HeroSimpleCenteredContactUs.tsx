// Generated page-specific component for contact-us
// This component is isolated - changes here only affect the contact-us page
...
export default function HeroSimpleCenteredContactUsContactUs(props: Props) {
  const {
    pageSlug = 'home',
